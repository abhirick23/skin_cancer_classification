...
Original file is located at
    https://colab.research.google.com/drive/1WCNCW4rasTCnjXsN9__gTFTIKDeB2iTR
"""
...
cd/gdrive/MyDrive/Skin_cancer_classification/
...
train_generator = train_datagen.flow_from_directory(
    '/gdrive/MyDrive/Skin_cancer_classification/',
    target_size=(224, 224),
    batch_size=32,
...
train_dataset = image_dataset_from_directory('/gdrive/MyDrive/Skin_cancer_classification/',
                                             shuffle=True,
...
vgg = VGG16(input_tensor=k.Input(shape=(224,224,3)),
            weights='imagenet',
            include_top=False,
            )
